...
#define NODE_MAIN_LOGGER_NAME "buff_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbuff_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_buff::BuffDetectorNode>";
