...
#define NODE_MAIN_LOGGER_NAME "buff_tracker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbuff_tracker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_buff::BuffTrackerNode>";
