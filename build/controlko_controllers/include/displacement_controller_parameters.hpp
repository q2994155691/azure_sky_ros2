#pragma message("#include \"displacement_controller_parameters.hpp\" is deprecated. Use #include <controlko_controllers/displacement_controller_parameters.hpp> instead.")
...
#include "validate_displacement_controller_parameters.hpp"


namespace displacement_controller {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("displacement_controller"), prefix) {
