...
class GameStatus(metaclass=Metaclass_GameStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.sync_timestamp = kwargs.get('sync_timestamp', int())
    ...
    def __eq__(self, other):
        ...
        if self.stage_remain_time != other.stage_remain_time:
            return False
        if self.sync_timestamp != other.sync_timestamp:
            return False
        return True
    ...
    def sync_timestamp(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'sync_timestamp' field must be of type 'int'"
            assert value >= 0 and value < 18446744073709551616, \
                "The 'sync_timestamp' field must be an unsigned integer in [0, 18446744073709551615]"
