...
class PowerHeatData(metaclass=Metaclass_PowerHeatData):
    ...
    def __init__(self, **kwargs):
        ...
        self.reserved3 = kwargs.get('reserved3', float())
    ...
    def reserved3(self, value):
        if __debug__:
            assert \
                ...
                "The 'reserved3' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'reserved3' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
