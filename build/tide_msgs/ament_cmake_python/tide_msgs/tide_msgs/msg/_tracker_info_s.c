...
bool tide_msgs__msg__tracker_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._tracker_info.TrackerInfo", full_classname_dest, 39) == 0);
  }
  tide_msgs__msg__TrackerInfo * ros_message = _ros_message;
  {  // position_diff
...
PyObject * tide_msgs__msg__tracker_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._tracker_info");
