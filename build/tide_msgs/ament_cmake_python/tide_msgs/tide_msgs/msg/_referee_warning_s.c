...
bool tide_msgs__msg__referee_warning__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._referee_warning.RefereeWarning", full_classname_dest, 45) == 0);
  }
  tide_msgs__msg__RefereeWarning * ros_message = _ros_message;
  {  // level
  ...
  {  // offending_robot_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "offending_robot_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->offending_robot_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // count
...
PyObject * tide_msgs__msg__referee_warning__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._referee_warning");
  ...
  {  // offending_robot_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->offending_robot_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "offending_robot_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
