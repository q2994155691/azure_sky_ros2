...
bool tide_msgs__msg__ground_robot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._ground_robot.GroundRobot", full_classname_dest, 39) == 0);
  }
  tide_msgs__msg__GroundRobot * ros_message = _ros_message;
  {  // hero_x
  ...
  {  // reserved1
    ...
    assert(PyFloat_Check(field));
    ros_message->reserved1 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // reserved2
    ...
    assert(PyFloat_Check(field));
    ros_message->reserved2 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of GroundRobot */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._ground_robot");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GroundRobot");
  ...
  {  // reserved1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->reserved1);
    {
  ...
  {  // reserved2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->reserved2);
    {
