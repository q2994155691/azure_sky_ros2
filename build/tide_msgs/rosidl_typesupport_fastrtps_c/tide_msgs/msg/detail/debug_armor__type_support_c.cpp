...
#include "tide_msgs/msg/detail/debug_armor__rosidl_typesupport_fastrtps_c.h"
...
using _DebugArmor__ros_msg_type = tide_msgs__msg__DebugArmor;
...
static uint32_t _DebugArmor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tide_msgs__msg__DebugArmor(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs__msg__DebugArmor;
    is_plain =
      (
...
static size_t _DebugArmor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tide_msgs__msg__DebugArmor(
