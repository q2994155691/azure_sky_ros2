...
#include "tide_msgs/msg/detail/tracker_info__rosidl_typesupport_fastrtps_c.h"
...
using _TrackerInfo__ros_msg_type = tide_msgs__msg__TrackerInfo;
...
size_t get_serialized_size_tide_msgs__msg__TrackerInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrackerInfo__ros_msg_type * ros_message = static_cast<const _TrackerInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrackerInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tide_msgs__msg__TrackerInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tide_msgs
size_t max_serialized_size_tide_msgs__msg__TrackerInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs__msg__TrackerInfo;
    is_plain =
      (
...
static size_t _TrackerInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tide_msgs__msg__TrackerInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tide_msgs, msg, TrackerInfo)() {
