...
#include "tide_msgs/msg/detail/buff__rosidl_typesupport_fastrtps_c.h"
...
using _Buff__ros_msg_type = tide_msgs__msg__Buff;
...
static uint32_t _Buff__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tide_msgs__msg__Buff(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs__msg__Buff;
    is_plain =
      (
...
static size_t _Buff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tide_msgs__msg__Buff(
