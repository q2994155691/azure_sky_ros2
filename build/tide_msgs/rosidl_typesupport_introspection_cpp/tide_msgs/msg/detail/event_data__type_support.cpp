...
{
  new (message_memory) tide_msgs::msg::EventData(_init);
}

void EventData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::EventData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EventData_message_member_array[1] = {
  {
    ...
    offsetof(tide_msgs::msg::EventData, event_data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EventData_message_members = {
  ...
  1,  // number of fields
  sizeof(tide_msgs::msg::EventData),
...
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::EventData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, EventData)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::EventData_message_type_support_handle;
}
