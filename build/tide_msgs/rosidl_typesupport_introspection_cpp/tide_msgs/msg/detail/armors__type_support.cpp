...
{
  new (message_memory) tide_msgs::msg::Armors(_init);
}

void Armors_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::Armors *>(message_memory);
  typed_message->~Armors();
}

size_t size_function__Armors__armors(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<tide_msgs::msg::Armor> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<tide_msgs::msg::Armor> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<tide_msgs::msg::Armor> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const tide_msgs::msg::Armor *>(
    get_const_function__Armors__armors(untyped_member, index));
  auto & value = *reinterpret_cast<tide_msgs::msg::Armor *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<tide_msgs::msg::Armor *>(
    get_function__Armors__armors(untyped_member, index));
  const auto & value = *reinterpret_cast<const tide_msgs::msg::Armor *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Armors_message_member_array[2] = {
  {
    ...
    offsetof(tide_msgs::msg::Armors, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<tide_msgs::msg::Armor>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::Armors, armors),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<tide_msgs::msg::Armors>()
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::Armors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, Armors)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::Armors_message_type_support_handle;
}
