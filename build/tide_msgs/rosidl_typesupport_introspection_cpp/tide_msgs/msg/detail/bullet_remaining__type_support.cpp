...
{
  new (message_memory) tide_msgs::msg::BulletRemaining(_init);
}

void BulletRemaining_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::BulletRemaining *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BulletRemaining_message_member_array[3] = {
  {
    ...
    offsetof(tide_msgs::msg::BulletRemaining, bullet_remaining_num_17mm),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::BulletRemaining, bullet_remaining_num_42mm),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::BulletRemaining, coin_remaining_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BulletRemaining_message_members = {
  ...
  3,  // number of fields
  sizeof(tide_msgs::msg::BulletRemaining),
...
get_message_type_support_handle<tide_msgs::msg::BulletRemaining>()
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::BulletRemaining_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, BulletRemaining)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::BulletRemaining_message_type_support_handle;
}
