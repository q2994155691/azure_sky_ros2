...
{
  new (message_memory) tide_msgs::msg::RFIDStatus(_init);
}

void RFIDStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::RFIDStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RFIDStatus_message_member_array[1] = {
  {
    ...
    offsetof(tide_msgs::msg::RFIDStatus, rfid_status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RFIDStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(tide_msgs::msg::RFIDStatus),
...
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::RFIDStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, RFIDStatus)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::RFIDStatus_message_type_support_handle;
}
