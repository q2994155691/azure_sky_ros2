...
{
  new (message_memory) tide_msgs::msg::DebugArmors(_init);
}

void DebugArmors_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::DebugArmors *>(message_memory);
  typed_message->~DebugArmors();
}

size_t size_function__DebugArmors__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<tide_msgs::msg::DebugArmor> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<tide_msgs::msg::DebugArmor> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<tide_msgs::msg::DebugArmor> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const tide_msgs::msg::DebugArmor *>(
    get_const_function__DebugArmors__data(untyped_member, index));
  auto & value = *reinterpret_cast<tide_msgs::msg::DebugArmor *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<tide_msgs::msg::DebugArmor *>(
    get_function__DebugArmors__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const tide_msgs::msg::DebugArmor *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugArmors_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<tide_msgs::msg::DebugArmor>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::DebugArmors, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DebugArmors_message_members = {
  ...
  1,  // number of fields
  sizeof(tide_msgs::msg::DebugArmors),
...
get_message_type_support_handle<tide_msgs::msg::DebugArmors>()
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::DebugArmors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, DebugArmors)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::DebugArmors_message_type_support_handle;
}
