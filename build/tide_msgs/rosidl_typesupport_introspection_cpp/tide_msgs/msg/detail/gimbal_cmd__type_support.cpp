...
{
  new (message_memory) tide_msgs::msg::GimbalCmd(_init);
}

void GimbalCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tide_msgs::msg::GimbalCmd *>(message_memory);
  typed_message->~GimbalCmd();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GimbalCmd_message_member_array[3] = {
  {
    "mode",  // name
    ...
    offsetof(tide_msgs::msg::GimbalCmd, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::GimbalCmd, pitch_ref),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tide_msgs::msg::GimbalCmd, yaw_ref),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GimbalCmd_message_members = {
  ...
  3,  // number of fields
  sizeof(tide_msgs::msg::GimbalCmd),
...
{
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::GimbalCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tide_msgs, msg, GimbalCmd)() {
  return &::tide_msgs::msg::rosidl_typesupport_introspection_cpp::GimbalCmd_message_type_support_handle;
}
