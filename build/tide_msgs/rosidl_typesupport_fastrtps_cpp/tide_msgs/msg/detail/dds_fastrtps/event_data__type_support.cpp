...
#include "tide_msgs/msg/detail/event_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::EventData;
    is_plain =
      (
      offsetof(DataType, event_data) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
