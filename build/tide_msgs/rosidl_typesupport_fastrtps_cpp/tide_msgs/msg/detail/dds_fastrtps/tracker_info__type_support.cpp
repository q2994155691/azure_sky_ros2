...
#include "tide_msgs/msg/detail/tracker_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::TrackerInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::TrackerInfo & ros_message)
{
  // Member: position_diff
  cdr >> ros_message.position_diff;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::TrackerInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::TrackerInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::TrackerInfo *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_TrackerInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, TrackerInfo)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_TrackerInfo__handle;
}
