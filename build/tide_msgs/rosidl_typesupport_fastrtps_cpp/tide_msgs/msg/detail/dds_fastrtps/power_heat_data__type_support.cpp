...
#include "tide_msgs/msg/detail/power_heat_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::PowerHeatData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::PowerHeatData & ros_message)
{
  // Member: reserved1
  cdr >> ros_message.reserved1;
  ...
  size_t current_alignment)
{
  ...
  // Member: buffer_energy
  {
    size_t item_size = sizeof(ros_message.buffer_energy);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: shooter_id1_17mm_cooling_heat
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::PowerHeatData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::PowerHeatData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::PowerHeatData *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_PowerHeatData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, PowerHeatData)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_PowerHeatData__handle;
}
