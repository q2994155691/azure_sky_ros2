...
#include "tide_msgs/msg/detail/bullet_remaining__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::BulletRemaining & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::BulletRemaining & ros_message)
{
  // Member: bullet_remaining_num_17mm
  cdr >> ros_message.bullet_remaining_num_17mm;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::BulletRemaining;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::BulletRemaining *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::BulletRemaining *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_BulletRemaining__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, BulletRemaining)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_BulletRemaining__handle;
}
