...
#include "tide_msgs/msg/detail/debug_armor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::DebugArmor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::DebugArmor & ros_message)
{
  // Member: center_x
  cdr >> ros_message.center_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::DebugArmor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::DebugArmor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::DebugArmor *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_DebugArmor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, DebugArmor)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_DebugArmor__handle;
}
