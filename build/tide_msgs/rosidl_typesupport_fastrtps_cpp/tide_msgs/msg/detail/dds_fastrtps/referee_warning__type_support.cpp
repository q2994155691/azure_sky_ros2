...
#include "tide_msgs/msg/detail/referee_warning__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::RefereeWarning & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: level
  cdr << ros_message.level;
  // Member: offending_robot_id
  cdr << ros_message.offending_robot_id;
  // Member: count
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::RefereeWarning & ros_message)
{
  // Member: level
  cdr >> ros_message.level;
  ...
  size_t current_alignment)
{
  ...
  // Member: offending_robot_id
  {
    size_t item_size = sizeof(ros_message.offending_robot_id);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: count
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::RefereeWarning;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::RefereeWarning *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::RefereeWarning *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_RefereeWarning__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, RefereeWarning)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_RefereeWarning__handle;
}
