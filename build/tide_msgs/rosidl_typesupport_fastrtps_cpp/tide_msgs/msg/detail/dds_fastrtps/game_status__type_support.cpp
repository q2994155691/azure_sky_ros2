...
#include "tide_msgs/msg/detail/game_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::GameStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.sync_timestamp;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::GameStatus & ros_message)
{
  // Member: game_type
  cdr >> ros_message.game_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: sync_timestamp
  {
    size_t item_size = sizeof(ros_message.sync_timestamp);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::GameStatus;
    is_plain =
      (
      offsetof(DataType, sync_timestamp) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::GameStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::GameStatus *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, GameStatus)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
