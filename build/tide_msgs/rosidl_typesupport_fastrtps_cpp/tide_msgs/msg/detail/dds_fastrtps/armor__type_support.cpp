...
#include "tide_msgs/msg/detail/armor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::Armor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::Armor & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::Armor;
    is_plain =
      (
      offsetof(DataType, kpts) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::Armor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::Armor *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, Armor)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
