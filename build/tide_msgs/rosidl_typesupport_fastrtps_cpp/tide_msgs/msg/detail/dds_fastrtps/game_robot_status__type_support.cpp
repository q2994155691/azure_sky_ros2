...
#include "tide_msgs/msg/detail/game_robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::GameRobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::GameRobotStatus & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::GameRobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::GameRobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::GameRobotStatus *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_GameRobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, GameRobotStatus)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_GameRobotStatus__handle;
}
