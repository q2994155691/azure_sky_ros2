...
#include "tide_msgs/msg/detail/rfid_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tide_msgs::msg::RFIDStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tide_msgs::msg::RFIDStatus & ros_message)
{
  // Member: rfid_status
  cdr >> ros_message.rfid_status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tide_msgs::msg::RFIDStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tide_msgs::msg::RFIDStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tide_msgs::msg::RFIDStatus *>(
    untyped_ros_message);
...
{
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_RFIDStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tide_msgs, msg, RFIDStatus)() {
  return &tide_msgs::msg::typesupport_fastrtps_cpp::_RFIDStatus__handle;
}
