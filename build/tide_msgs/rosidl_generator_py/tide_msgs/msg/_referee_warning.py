...
class RefereeWarning(metaclass=Metaclass_RefereeWarning):
    ...
    def __init__(self, **kwargs):
        ...
        self.offending_robot_id = kwargs.get('offending_robot_id', int())
    ...
    def __eq__(self, other):
        ...
        if self.level != other.level:
            return False
        if self.offending_robot_id != other.offending_robot_id:
            return False
    ...
    @builtins.property
    def offending_robot_id(self):
        """Message field 'offending_robot_id'."""
        return self._offending_robot_id

    @offending_robot_id.setter
    def offending_robot_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'offending_robot_id' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'offending_robot_id' field must be an unsigned integer in [0, 255]"
        self._offending_robot_id = value
