...
bool tide_msgs__msg__debug_armor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._debug_armor.DebugArmor", full_classname_dest, 37) == 0);
  }
  tide_msgs__msg__DebugArmor * ros_message = _ros_message;
  {  // center_x
...
PyObject * tide_msgs__msg__debug_armor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._debug_armor");
