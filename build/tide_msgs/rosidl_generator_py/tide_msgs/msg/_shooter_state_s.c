...
bool tide_msgs__msg__shooter_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._shooter_state.ShooterState", full_classname_dest, 41) == 0);
  }
  tide_msgs__msg__ShooterState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ShooterState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._shooter_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ShooterState");
