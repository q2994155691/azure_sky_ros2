...
bool tide_msgs__msg__fd_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._fd_frame.FdFrame", full_classname_dest, 31) == 0);
  }
  tide_msgs__msg__FdFrame * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FdFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._fd_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FdFrame");
