...
class Armor(metaclass=Metaclass_Armor):
    ...
    _fields_and_field_types = {
        ...
        'kpts': 'sequence<geometry_msgs/Point>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'kpts' field must be a set or sequence and each value of type 'Point'"
        self._kpts = value
