...
bool tide_msgs__msg__game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._game_status.GameStatus", full_classname_dest, 37) == 0);
  }
  tide_msgs__msg__GameStatus * ros_message = _ros_message;
  {  // game_type
  ...
  {  // sync_timestamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "sync_timestamp");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->sync_timestamp = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * tide_msgs__msg__game_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._game_status");
  ...
  {  // sync_timestamp
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->sync_timestamp);
    {
      int rc = PyObject_SetAttrString(_pymessage, "sync_timestamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
