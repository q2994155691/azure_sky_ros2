...
class Metaclass_GroundRobot(type):
    """Metaclass of message 'GroundRobot'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'tide_msgs.msg.GroundRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ground_robot
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ground_robot
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ground_robot
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ground_robot
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ground_robot
...
class GroundRobot(metaclass=Metaclass_GroundRobot):
    """Message class 'GroundRobot'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.reserved1 = kwargs.get('reserved1', float())
        self.reserved2 = kwargs.get('reserved2', float())
    ...
    def reserved1(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'reserved1' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'reserved1' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def reserved2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'reserved2' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'reserved2' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
