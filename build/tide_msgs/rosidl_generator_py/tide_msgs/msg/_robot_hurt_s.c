...
bool tide_msgs__msg__robot_hurt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._robot_hurt.RobotHurt", full_classname_dest, 35) == 0);
  }
  tide_msgs__msg__RobotHurt * ros_message = _ros_message;
  {  // armor_id
...
PyObject * tide_msgs__msg__robot_hurt__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._robot_hurt");
