...
#ifndef TIDE_MSGS__MSG__DETAIL__FD_FRAME__STRUCT_HPP_
#define TIDE_MSGS__MSG__DETAIL__FD_FRAME__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__tide_msgs__msg__FdFrame __attribute__((deprecated))
#else
# define DEPRECATED__tide_msgs__msg__FdFrame __declspec(deprecated)
#endif
...
struct FdFrame_
{
  ...
  // pointer types
  using RawPtr =
    tide_msgs::msg::FdFrame_<ContainerAllocator> *;
  using ConstRawPtr =
    const tide_msgs::msg::FdFrame_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tide_msgs::msg::FdFrame_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tide_msgs__msg__FdFrame
    std::shared_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tide_msgs__msg__FdFrame
    std::shared_ptr<tide_msgs::msg::FdFrame_<ContainerAllocator> const>
...
using FdFrame =
  tide_msgs::msg::FdFrame_<std::allocator<void>>;
...
#endif  // TIDE_MSGS__MSG__DETAIL__FD_FRAME__STRUCT_HPP_
