...
#define NODE_MAIN_LOGGER_NAME "rm_auto_record_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_auto_record.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_record::RecordNode>";
