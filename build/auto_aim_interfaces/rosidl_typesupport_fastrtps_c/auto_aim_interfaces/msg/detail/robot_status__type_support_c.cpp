...
#include "auto_aim_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = auto_aim_interfaces__msg__RobotStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pitch_velocity
  {
    cdr << ros_message->pitch_velocity;
  }

  // Field name: yaw_current
  {
    cdr << ros_message->yaw_current;
  }

  // Field name: pitch_current
  {
    cdr << ros_message->pitch_current;
  }

  // Field name: yaw_temperature
  {
    cdr << ros_message->yaw_temperature;
  }

  // Field name: pitch_temperature
  {
    cdr << ros_message->pitch_temperature;
  }
...
size_t get_serialized_size_auto_aim_interfaces__msg__RobotStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotStatus__ros_msg_type * ros_message = static_cast<const _RobotStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name pitch_velocity
  {
    size_t item_size = sizeof(ros_message->pitch_velocity);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name yaw_current
  {
    size_t item_size = sizeof(ros_message->yaw_current);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pitch_current
  {
    size_t item_size = sizeof(ros_message->pitch_current);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name yaw_temperature
  {
    size_t item_size = sizeof(ros_message->yaw_temperature);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pitch_temperature
  {
    size_t item_size = sizeof(ros_message->pitch_temperature);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__RobotStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__RobotStatus;
    is_plain =
      (
      offsetof(DataType, pitch_temperature) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__RobotStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, RobotStatus)() {
