...
tide_msgs__msg__GameRobotPos__create()
{
  ...
  tide_msgs__msg__GameRobotPos * msg = (tide_msgs__msg__GameRobotPos *)allocator.allocate(sizeof(tide_msgs__msg__GameRobotPos), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tide_msgs__msg__GameRobotPos));
  bool success = tide_msgs__msg__GameRobotPos__init(msg);
  if (!success) {
...
tide_msgs__msg__GameRobotPos__destroy(tide_msgs__msg__GameRobotPos * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tide_msgs__msg__GameRobotPos__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tide_msgs__msg__GameRobotPos__Sequence__init(tide_msgs__msg__GameRobotPos__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tide_msgs__msg__GameRobotPos * data = NULL;

  if (size) {
    data = (tide_msgs__msg__GameRobotPos *)allocator.zero_allocate(size, sizeof(tide_msgs__msg__GameRobotPos), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tide_msgs__msg__GameRobotPos__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tide_msgs__msg__GameRobotPos__fini(&data[i - 1]);
      }
...
tide_msgs__msg__GameRobotPos__Sequence__fini(tide_msgs__msg__GameRobotPos__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tide_msgs__msg__GameRobotPos__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tide_msgs__msg__GameRobotPos__Sequence * array = (tide_msgs__msg__GameRobotPos__Sequence *)allocator.allocate(sizeof(tide_msgs__msg__GameRobotPos__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tide_msgs__msg__GameRobotPos__Sequence__init(array, size);
  if (!success) {
...
tide_msgs__msg__GameRobotPos__Sequence__destroy(tide_msgs__msg__GameRobotPos__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tide_msgs__msg__GameRobotPos__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tide_msgs__msg__GameRobotPos__Sequence__are_equal(const tide_msgs__msg__GameRobotPos__Sequence * lhs, const tide_msgs__msg__GameRobotPos__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tide_msgs__msg__GameRobotPos__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tide_msgs__msg__GameRobotPos__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tide_msgs__msg__GameRobotPos);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tide_msgs__msg__GameRobotPos * data =
      (tide_msgs__msg__GameRobotPos *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tide_msgs__msg__GameRobotPos__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tide_msgs__msg__GameRobotPos__fini(&output->data[i]);
        }
        return false;
      }
    }
