...
tide_msgs__msg__ShootData__create()
{
  ...
  tide_msgs__msg__ShootData * msg = (tide_msgs__msg__ShootData *)allocator.allocate(sizeof(tide_msgs__msg__ShootData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tide_msgs__msg__ShootData));
  bool success = tide_msgs__msg__ShootData__init(msg);
  if (!success) {
...
tide_msgs__msg__ShootData__destroy(tide_msgs__msg__ShootData * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tide_msgs__msg__ShootData__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tide_msgs__msg__ShootData__Sequence__init(tide_msgs__msg__ShootData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tide_msgs__msg__ShootData * data = NULL;

  if (size) {
    data = (tide_msgs__msg__ShootData *)allocator.zero_allocate(size, sizeof(tide_msgs__msg__ShootData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tide_msgs__msg__ShootData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tide_msgs__msg__ShootData__fini(&data[i - 1]);
      }
...
tide_msgs__msg__ShootData__Sequence__fini(tide_msgs__msg__ShootData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tide_msgs__msg__ShootData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tide_msgs__msg__ShootData__Sequence * array = (tide_msgs__msg__ShootData__Sequence *)allocator.allocate(sizeof(tide_msgs__msg__ShootData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tide_msgs__msg__ShootData__Sequence__init(array, size);
  if (!success) {
...
tide_msgs__msg__ShootData__Sequence__destroy(tide_msgs__msg__ShootData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tide_msgs__msg__ShootData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tide_msgs__msg__ShootData__Sequence__are_equal(const tide_msgs__msg__ShootData__Sequence * lhs, const tide_msgs__msg__ShootData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tide_msgs__msg__ShootData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tide_msgs__msg__ShootData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tide_msgs__msg__ShootData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tide_msgs__msg__ShootData * data =
      (tide_msgs__msg__ShootData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tide_msgs__msg__ShootData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tide_msgs__msg__ShootData__fini(&output->data[i]);
        }
        return false;
      }
    }
