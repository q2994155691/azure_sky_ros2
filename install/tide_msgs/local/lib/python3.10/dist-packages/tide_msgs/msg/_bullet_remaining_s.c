...
bool tide_msgs__msg__bullet_remaining__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._bullet_remaining.BulletRemaining", full_classname_dest, 47) == 0);
  }
  tide_msgs__msg__BulletRemaining * ros_message = _ros_message;
...
PyObject * tide_msgs__msg__bullet_remaining__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._bullet_remaining");
