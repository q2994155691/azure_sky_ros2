...
bool tide_msgs__msg__event_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tide_msgs.msg._event_data.EventData", full_classname_dest, 35) == 0);
  }
  tide_msgs__msg__EventData * ros_message = _ros_message;
  {  // event_data
...
PyObject * tide_msgs__msg__event_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tide_msgs.msg._event_data");
